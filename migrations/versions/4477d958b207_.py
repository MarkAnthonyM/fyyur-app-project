...
Revision ID: 4477d958b207
Revises: 
Create Date: 2020-06-09 13:11:35.317242
...
def upgrade():
    ...
    sa.Column('past_show_count', sa.Integer(), nullable=False),
    sa.Column('upcoming_show_count', sa.Integer(), nullable=False),
